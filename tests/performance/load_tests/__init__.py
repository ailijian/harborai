...
LOAD_TEST_CONFIG = {
    ...
    'load_levels': {
        'light': {
            ...
            'duration_minutes': 0.1,  # 6秒
            'ramp_up_seconds': 2
        },
        'normal': {
            'concurrent_users': 3,
            'requests_per_second': 2,
            'duration_minutes': 0.15,  # 9秒
            'ramp_up_seconds': 3
        },
        'heavy': {
            'concurrent_users': 5,
    ...
    'test_scenarios': {
        'gradual_ramp': {
            ...
            'phase_duration_minutes': 0.2
        },
        'spike_test': {
            'description': '突发负载测试',
            'base_load': 'light',
            'spike_load': 'normal',
            'spike_duration_minutes': 0.2,
            'spike_interval_minutes': 0.3
        },
        'endurance_test': {
            'description': '持续负载测试',
            'load_level': 'normal',
